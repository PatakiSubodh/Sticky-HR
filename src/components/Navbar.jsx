...
const features = [
    {
        ...
        href: "/features/user-mangement",
        bgHover: "hover:bg-[#F1F8FF]",
        img: img1,
    },
    {
        title: "Expense Management",
        href: "/features/expense-mangement",
        bgHover: "hover:bg-[#F4FEFF]",
        img: img2,
    },
    {
        title: "Attendance Management",
        href: "/features/attendance-mangement",
        bgHover: "hover:bg-[#FFF3EF]",
        img: img3,
    },
    {
        title: "Assets Management",
        href: "/features/assets-mangement",
        bgHover: "hover:bg-[#EFFFF5]",
        img: img4,
    },
    {
        title: "Leave Management",
        href: "/features/leave-mangement",
        bgHover: "hover:bg-[#F7F4FF]",
        img: img5,
    },
    {
        title: "Document Management",
        href: "/features/document-mangement",
        bgHover: "hover:bg-[#EBF8FF]",
        img: img6,
    },
    {
        title: "Payroll Management",
        href: "/features/payroll-mangement",
...
const services = [
    {
        ...
        href: "/services/virtaul-hr-service",
        bgHover: "hover:bg-[#F1F8FF]",
        img: serImg1,
    },
    {
