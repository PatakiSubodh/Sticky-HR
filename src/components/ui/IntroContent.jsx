        ...
        <div className="intro-content grid xl:grid-cols-2 grid-cols-1 2xl:gap-8 xl:gap-6 items-center h-full md:grid-cols-1">
            ...
            <div className="intro-right flex justify-center relative mt-6 sm:mt-8 lg:mt-0">
                ...
                <img
                    src={img1}
                    alt="Icon 1"
                    className="hidden sm:block absolute xl:top-[5%] xl:right-[5%] md:top-[10%] md:right-[13%] top-[15%] right-[5%] sm:w-16 sm:h-16 rotate-13 -z-10"
                    loading="lazy"
                />
                <img
                    src={img2}
                    alt="Icon 2"
                    className="hidden sm:block absolute xl:top-[30%] xl:left-[5%] md:top-[35%] md:left-[10%] top-[35%] left-[5%] sm:w-16 sm:h-16 -rotate-6 -z-10"
                    loading="lazy"
                />
                <img
                    src={cir1}
                    alt="Circle 1"
                    className="hidden sm:block absolute top-[5%] left-[10%] xl:top-[3%] xl:left-[5%] md:top-[5%] md:left-[10%] w-5 sm:w-6 h-5 sm:h-6 -z-10"
                    loading="lazy"
                />
                <img
                    src={cir2}
                    alt="Circle 2"
                    className="hidden sm:block absolute top-[20%] left-[20%] xl:top-[10%] xl:left-[15%] md:top-[20%] md:left-[20%] w-2 sm:w-3 h-2 sm:h-3 -z-10"
                    loading="lazy"
                />
                ...
                <div className="bg-gray-100 p-4 sm:p-6 lg:p-8 opacity-100 rounded-xl shadow-sm w-full max-w-[280px] sm:max-w-xs lg:max-w-sm xl:max-w-md shadow-gray-400">
                    ...
                    <form className="space-y-3 sm:space-y-4 lg:space-y-5">
                        ...
                        <button
                            type="submit"
                            className="w-full bg-[#086165] text-sm sm:text-base lg:text-lg text-white font-bold p-2 sm:p-3 rounded-md hover:bg-[#064d4b] transition active:scale-95"
